...
import type { ProjectRepositories, ProjectUnitOfWork } from "../application/ports/ProjectUnitOfWork.js";

export class PrismaProjectUnitOfWork implements ProjectUnitOfWork {
    constructor(private readonly client: PrismaClient) { }

    async transaction<T>(work: (repositories: ProjectRepositories) => Promise<T>): Promise<T> {
