...
// assertion touches whichever of the nine the assertion names, plus
// `assertions`, plus either `content_revisions` or
...
// convenience: `AssertionRepository.claimForApply()` (step 4b-5) takes
...
export type NarrativeTransitionRepositories = {
  ...
  // Written by `relationship_add` / `relationship_remove` assertions. This is the
