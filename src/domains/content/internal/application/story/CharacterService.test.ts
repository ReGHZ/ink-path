...
function createService() {
  ...
  return {
    ...
    relationships,
    locator,
    service: new CharacterService(clock, idGenerator, characters, uow, locator),
  };
}
...
describe("CharacterService", () => {
  ...
  describe("deleteCharacter", () => {
    ...
    it("refuses the delete while a content relationship still points at the character, and names the blocker", async () => {
      const {
        characters,
        contentRevisions,
        outboxEvents,
      ...
      locator.seed("faction", "faction-9", {
        projectId: "proj-1",
