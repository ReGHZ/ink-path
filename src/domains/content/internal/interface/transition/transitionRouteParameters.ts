...
// can drift silently: renaming `:assertionId` in the router alone leaves
...
// an assertion would. Making the disagreement unexpressible is the same move the
...
export const ASSERTION_ID_PARAMETER = "assertionId";
